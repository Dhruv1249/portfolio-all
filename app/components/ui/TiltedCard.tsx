...
export default function TiltedCard({
  ...
  return (
    ...
    >
      {showMobileWarning && (
        <div className="absolute top-4 text-center text-sm block md:hidden text-zinc-500">
      ...
      >
        <motion.img
          src={imageSrc}
          alt={altText}
          className="absolute top-0 left-0 object-cover rounded-[16px] will-change-transform [transform:translateZ(0)]"
          style={{
            width: imageWidth,
            height: imageHeight
          }}
